...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-09-2022 a las 04:07:56
...
(6, 'Encuentro con niños', '2024-04-21', '17:10', 'Hondarrubia', '`23', 'Bilbao', 'Vizcaya', 'España');
...
INSERT INTO `cliente` (`dniCliente`, `nombreCliente`, `apellidosCliente`, `calleCliente`, `numeroCliente`, `localidadCliente`, `provinciaCliente`, `paisCliente`, `telefonoCliente`, `emailCliente`) VALUES
(0, 'a', 'a', 'a', 1, 'a', 'a', 'a', '1', 'a@gmail.com'),
(1, 'a', 'a', 'a', 1, 'a', 'a', 'a', '1', 'a'),
(2, 'b', 'b', 'b', 2, 'b', 'b', 'b', '23', 'b'),
(3, 'Javier', 'Serrano', 'Luz', 2, 'Puertollano', 'Ciudad Real', 'España', '1234567', 'javier@hotmail.com'),
(123, 'a', 'a', 'a', 1, 'a', 'a', 'a', '1', 'a@gmail.com'),
(333, 'Prueba', 'a', 'a', 1, 'a', 'a', 'a', '1', 'a@gmail.com'),
(666, 'Prueba', 'a', 'a', 1, 'a', 'a', 'a', '1', ''),
(888, 'Prueba', 'a', 'a', 1, 'a', 'a', 'a', 'a', 'a@gmail.com'),
(999, 'a', 'a', 'a', 1, 'a', 'a', 'a', '1', 'w@gmail.com'),
(1000, 'b', 'b', 'b', 1, 'b', 'b', 'b', 'b', 'b@gmail.com'),
(1001, 'Prueba', 'a', 'a', 1, 'a', 'a', 'a', '1', 'a@gmail.com'),
(1111, 'a', 'a', 'a', 1, 'a', 'a', 'a', '1', 'a@gmail.com'),
(4578, 'Prueba', 'aa', 'aa', 1, 'aa', 'aa', 'aa', '1', 'a@gmail.com'),
(5555, 'aaa', 'aaa', 'aaaa', 1, '1', 'a', 'a', '1', 'a@mail.com'),
(2615659, 'Javier', 'Serrano Sánchez', 'Pez', 2, 'Madrid', 'Madrid', 'España', '1234567', 'javier@gmail.com');
...
CREATE TABLE `mail` (
  `idMail` int(5) NOT NULL,
  `remiteMail` varchar(50) DEFAULT NULL,
  `nombreMail` varchar(30) DEFAULT NULL,
  `apellidoMail` varchar(50) DEFAULT NULL,
  `telefonoMail` varchar(11) DEFAULT NULL,
  `textoMail` mediumtext DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
('alfa2@gmail.com'),
('b@hotmail.com'),
('javierprueba@hotmail.com'),
('prueba5@hotmail.com'),
('prueba@hotmail.com'),
('pruebahoy@hotmail.com');
...
ALTER TABLE `cliente`
  ...
  ADD UNIQUE KEY `id_cliente_UNIQUE` (`dniCliente`);
...
--
ALTER TABLE `mail`
  MODIFY `idMail` int(5) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `carro`
  ADD CONSTRAINT `fk_carro_cliente1` FOREIGN KEY (`cliente_idCliente`) REFERENCES `cliente` (`dniCliente`) ON DELETE NO ACTION ON UPDATE NO ACTION;
